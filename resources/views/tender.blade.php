...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
          ...
          <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    @if($user->level == 'superadmin' || $user->level == 'admin-marketing'|| $user->level == 'admin' || $user->level == 'marketing')
                          ...
                          <div class="card-body table-responsive">
                            <table id="tabel-tender" class="table table-bordered table-striped">
                              ...
                              <tr>
                                ...
                                <th style="min-width:300px">Dokumen</th>
                              </tr>
                              </thead>
                              <tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <button type="button" class="btn btn-primary" id="tambah-instansi">Tambah Instansi</button>
                                </div>
                                <div id="add-instansi">
                                    <form id="form-tambah-instansi" action="#">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <select class="form-control select2" id="tambahnamainstansi" name="tambahnamainstansi"></select>
                                                <br>
                                                <input type="text" id="tambah_nama_instansi" name="tambah_nama_instansi" class="form-control">
                                            </div>
                                            <div class='col-lg-2'>
                                                <label>Username</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" id="tambah_username_instansi" name="tambah_username_instansi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" class="form-control" id="tambah_sub_instansi" name="tambah_sub_instansi">
                                            </div>
                                            <div class='col-lg-2'>
                                                <label>Password</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" id="tambah_password_instansi" name="tambah_password_instansi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="email" id="tambah_email_instansi" name="tambah_email_instansi" class="form-control">
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Link Tender</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" id="tambah_link_instansi" name="tambah_link_instansi" class="form-control">
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-2">
                                              <button type="button" id="btn-close-instansi" class="form-control btn btn-default">Close</button>
                                            </div>
                                            <div class="col-lg-2">
                                                <button type="submit" id="btn-tambah-instansi" class=" form-control btn btn-primary">Tambah</button>
                                            </div>
                                        </div>
                                    </form>
                                      
                                </div>
                                <div id="edit-instansi">
                                    <form id="form-edit-instansi" action="#" >
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="hidden" id="edit_id_instansi" name="edit_id_instansi" class="form-control">
                                                <select class="form-control select2" id="editnamainstansi" name="editnamainstansi"></select>
                                                <br>
                                                <input type="text" id="edit_nama_instansi" name="edit_nama_instansi" class="form-control">
                                            </div>
                                            <div class='col-lg-2'>
                                                <label>Username</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" id="edit_username_instansi" name="edit_username_instansi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="edit_sub_instansi" name="edit_sub_instansi" class="form-control">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" id="edit_password_instansi" name="edit_password_instansi" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="email" id="edit_email_instansi" name="edit_email_instansi" class="form-control">
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Link Tender</label>
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="text" id="edit_link_instansi" name="edit_link_instansi" class="form-control">
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-lg-8"></div>
                                            <div class="col-lg-2">
                                              <button type="button" id="btn-edit-close-instansi" class="form-control btn btn-default">Close</button>
                                            </div>
                                            <div class="col-lg-2">
                                                <button type="submit" id="btn-edit-instansi" class=" form-control btn btn-warning">Edit</button>
                                            </div>
                                        </div>
                                    </form>
                                       
                                </div>
                                <div id="hapus-instansi" action="#">
                                    
                                    <form id="form-hapus-instansi">
                                        <div class="row">
                                            <h5><b>Apakah Anda Yakin, Menghapus Data Berikut ??</b></h5>
                                        </div>
                                        <div class="row">
                                            <input type="hidden" id="hapus_id_instansi"name="hapus_id_instansi" class="form-control">
                                            <div class="col-lg-2"><label>Nama Instansi</label></div>
                                            <div class="col-lg-1">:</div>
                                            <div class="col-lg-5" id="hapus_nama_instansi"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-lg-8"></div>
                                            <div class="col-lg-2">
                                              <button type="button" id="btn-hapus-close-instansi" class="form-control btn btn-default">Close</button>
                                            </div>
                                            <div class="col-lg-2">
                                                <button type="submit" id="btn-hapus-instansi" class=" form-control btn btn-danger">Hapus</button>
                                            </div>
                                        </div>  
                                    </form>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped" id="tabel-instansi">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="min-width:120px">Nama Instansi</th>
                                                <th style="min-width:120px">Sub Instansi</th>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select class="form-control select2" id="tambah_instansi_pejabat" name="tambah_instansi_pejabat"></select>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" id="detail_instansi_pejabat" class="form-control" readonly>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <select class="form-control" id="edit_instansi_pejabat" name="edit_instansi_pejabat"></select>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
        ...
        <!-- Modal Instansi -->
        <!-- Modal Sub Instansi -->
            <div class="modal fade" id="modal-sub-instansi">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h4 class="modal-title">Pilih Sub Instansi</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                ...
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select id="tambah_instansi" class="form-control select2" required></select>
                                                </div>
                                            </div>
                                            <div class="row sub_instansi">
                                                ...
                                                <div class="col-lg-8">
                                                    <select id="tambah_subinstansi" class="form-control select2 " required></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-lg-2'>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="email" id="tambah_email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-lg-2">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select id="edit_instansi" class="form-control select2" required></select>
                                                </div>
                                            </div>
                                            <div class="row sub_instansi">
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control select2" id="edit_subinstansi" required></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-lg-2'>
        ...
        <script>
          ...
          $(document).ready(function() {  
            ...
            $('#menu').html(<?php echo json_encode($menu); ?>);
            @if($user->level != 'manager-marketing'||$user->level !='ceo')
            var table = $('#tabel-tender').DataTable({
              ...
              "fnRowCallback": function(nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                if (aData['status'] === 'lunas') {
                    // Tambahkan kelas CSS "bg-success" ke baris tabel
              ...
              "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
                processing: true,
                serverSide: true,
                ajax: '{!! url("data-tender") !!}',
                "columnDefs": [
                    {
                        targets: 2, // Sesuaikan dengan indeks kolom yang sesuai
                        render: function(data, type, row) {
                            if (type === 'display' && typeof data === 'string') {
                                var instansi = JSON.parse(data);
                                return "<b>" + instansi.nama + "</b><br><span>" + instansi.sub_instansi + "</span>";
                                // var dataArray = JSON.parse(data);
                                // var result = '';
                                // dataArray.forEach(function(item) {
                                //     result += item.nama + " - " + item.qty +" "+ item.satuan + "<br>";
                                // });
                                // return result;
                            }
                    ...
                    {
                        targets: 5, // Sesuaikan dengan indeks kolom yang sesuai
                        render: function(data, type, row) {
                            if (type === 'display' && typeof data === 'string') {
                                var dataArray = JSON.parse(data);
                                var result = '';
                    ...
                    {
                        "targets": [6], // Sesuaikan dengan indeks kolom 'detail'
                    ...
                    {
                        targets: 10, // Sesuaikan dengan indeks kolom yang sesuai
                        render: function(data, type, row) {
                            if (type === 'display' && typeof data === 'string') {
                                var dataArray = JSON.parse(data);
                                var result = '';
                    ...
                    {
                        "targets": [13], // Sesuaikan dengan indeks kolom 'detail'
                        "render": function (data, type, row, meta) {
                            // Di sini, kita mengembalikan HTML untuk tombol
                    ...
                    {
                        targets: 14, // Sesuaikan dengan indeks kolom yang sesuai
                        render: function(data, type, row) {
                            if (type === 'display' && typeof data === 'string') {
                                var dataArray = JSON.parse(data);
                                var result = '';
                    ...
                    {
                        targets: 15, // Ganti 'x' dengan indeks kolom yang sesuai
                        render: function(data, type, row) {
                            if (type === 'display' && typeof data === 'string') {
                                var dataArray = JSON.parse(data);
                                var result = '';
                                dataArray.forEach(function(item) {
                                    var keteranganArray = item.keterangan.split(',');
                                    var keteranganHtml = '<ul>';
                                    keteranganArray.forEach(function(keterangan) {
                                        keteranganHtml += '<li>' + keterangan + '</li>';
                                    });
                                    keteranganHtml += '</ul>';
                                    var icon = (item.siap === 'ya') ? "<i class='fas fa-check-circle' style='color:green;'></i>" :
                                        "<i class='fas fa-times-circle' style='color:red;'></i>";
                                    result += "<li>" + item.nama + " " + icon + keteranganHtml +"</li>";
                                });
                                return "<ul>"+result+"</ul>";
                            }
                            return data; // Kembalikan data asli jika bukan untuk display atau bukan array JSON
                    ...
                    { 
                        "targets": [7,8,9, 10,14,15], // Sesuaikan dengan indeks kolom 'kompetitor' dan 'kompetitor_harga'
            ...
            $('#tabel-tender tbody').on('click', 'button.btn-detail-barang', function() {
                ...
                var colqty = table.column(7).visible();
                var colhps = table.column(8).visible();
                var colharga = table.column(9).visible();
                var colongkir = table.column(10).visible();
        
                // Toggle visibilitas berdasarkan status saat ini
                table.column(7).visible(!colqty);
                table.column(8).visible(!colhps);
                table.column(9).visible(!colharga);
                table.column(10).visible(!colongkir);
            });
            $('#tabel-tender tbody').on('click', 'button.btn-detail', function() {
                ...
                // Logika untuk toggle (menampilkan dan menyembunyikan) kolom
                // Cek apakah kolom sudah ditampilkan atau tidak
                var colKompetitorVisible = table.column(14).visible();
                var colKompetitorHargaVisible = table.column(15).visible();
        
                // Toggle visibilitas berdasarkan status saat ini
                table.column(14).visible(!colKompetitorVisible);
                table.column(15).visible(!colKompetitorHargaVisible);
            });
            @endif
          }); 
         
          // Sub Instansi
            $('body').on('click', '.subinstansi', function() {
                var kode = $(this).data('kode'); // Mendapatkan nilai data-kode dari tombol yang diklik
                var warna = $(this).data('warna'); // Mendapatkan nilai data-warna dari tombol yang diklik
            
                // Menghapus kelas CSS yang ada pada header modal
                $('#modal-sub-instansi .modal-header').removeClass().addClass('modal-header');
            
                // Menambahkan kelas CSS yang diberikan sebagai warna latar belakang header modal
                $('#modal-sub-instansi .modal-header').addClass(warna);
            
                // Jika Anda ingin mengubah teks atau elemen lainnya di dalam header modal, Anda dapat menambahkan kode di sini
                // Misalnya, mengubah teks judul modal
                $('#modal-sub-instansi .modal-title').text('Data Subinstansi ' + kode);
                
                $.ajax({
                    url :'{!! url("data-subinstansi/'+kode+'") !!}',
                    type : 'get',
                    success : function(response){
                        ...
                        if(response.success == true){
                            ...
                            $.each(response.data, function(index, sub) {
                                var Nrow = $("<div class='row' style='margin-bottom:10px'>");
                                Nrow.html("<div class='col-lg-8'><b>"+sub['sub_instansi']+"</b></div></div class='col-lg-4'><a class='btn btn-default' href='tender/" + sub['id'] + "'>Buka Tender</a></div></div>");
                                $('#sub-instansi').append(Nrow);
                            });
                        } else {
                            Toast.fire({
                                icon    : "error",
          ...
          //Tambah
              $(document).on('click','#tambahdata',function(){
                ...
                $('#tambah_subinstansi').hide(); 
                $('.sub_instansi').hide(); 
                $('#tambah_instansi').select2({
                  placeholder : 'Pilih Instansi',
                  ajax  :{
                    url : '{!! url("dropdown-instansitender") !!}',
                    dataType: 'json',
                ...
                $('#tambah_instansi').on('change',function(){
                    var nama = $(this).val();
                    console.log(nama);
                    if(nama == "Baru" || nama == null){
                        $('.sub_instansi').hide(); 
                    } else {
                        $('.sub_instansi').show(); 
                        $('#tambah_subinstansi').select2({
                          placeholder : 'Pilih Sub Instansi',
                          ajax  :{
                            url : '{!! url("dropdown-subinstansi/'+nama+'") !!}',
                            dataType: 'json',
                              processResults: function (data) {
                                  console.log(data);
                                  return {
                ...
                $('#tambah_subinstansi').on('change',function(){
                   var id = $(this).val();
                   console.log(id);
                   $.ajax({
                      url :'{!! url("data-instansitender/'+id+'/edit") !!}',
                      type : 'get',
                      success : function(response){
                        console.log(response);
                        $('#tambah_link').val(response.data.link);
                        $('#tambah_email').val(response.data.email);
                        $('#tambah_pic').select2({
                          placeholder : 'Pilih Pejabat',
                          ajax  :{
                            url : '{!! url("dropdown-pejabattender/'+id+'") !!}',
                            dataType: 'json',
                              processResults: function (data) {
                                  console.log(data);
                                  return {
          ...
          //Edit
            ...
            $('#edit_instansi').on('change',function(){
               var nama = $(this).val();
               if(nama == "Baru" || nama == null){
                   $('.sub_instansi').hide(); 
               } else {
                   $('.sub_instansi').show(); 
                   $('#edit_subinstansi').select2({
                      placeholder : 'Pilih Sub Instansi',
                      ajax  :{
                        url : '{!! url("dropdown-subinstansi/'+nama+'") !!}',
                        dataType: 'json',
            ...
            $('#edit_subinstansi').on('change',function(){
                var id = $(this).val();
                $.ajax({
                  url :'{!! url("data-instansitender/'+id+'/edit") !!}',
                  type : 'get',
                      ...
                      if(response.success == true){
                        ...
                        $('#edit_instansi')
                          ...
                          .append($("<option/>") //add option tag in select
                              .val(response.tender.namainstansi) //set value for option to post it
                              .text(response.tender.namainstansi )) //set a text for show in select
                          .val(response.tender.namainstansi) //select option of select2
                          .trigger("change"); //apply to select2
                        $('#edit_instansi').select2({
                        ...
                        $('#edit_subinstansi')
                          .empty() //empty select
                          .append($("<option/>") //add option tag in select
                              .val(response.tender.instansi) //set value for option to post it
                              .text(response.tender.subinstansi )) //set a text for show in select
                          .val(response.tender.instansi) //select option of select2
                          .trigger("change"); //apply to select2
                        $('#edit_subinstansi').select2({
                          placeholder : 'Pilih Sub Instansi',
                          ajax  :{
                            url : '{!! url("dropdown-subinstansi/'+response.tender.namainstansi+'") !!}',
                            dataType: 'json',
                              processResults: function (data) {
                                  console.log(data);
                                  return {
                        ...
                        $('#edit_pic').empty().append($("<option/>").val(response.tender.pic).text(response.tender.namapic)).val(response.tender.pic).trigger("change");
                        $('#edit_pic').select2({
                          placeholder:"Pilih Pejabat",
                          ajax  :{
          ...
          $(document).on('click','#tambahinstansi',function(e){
                ...
                if ($.fn.DataTable.isDataTable('#tabel-instansi')) {
                    $('#tabel-instansi').DataTable().destroy();
                }
                ...
                $('#tabel-instansi').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: '{!! url("data-instansitender") !!}',
                    columns: [         
                        { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable:false, searchable:false},
                        { data: 'action', name: 'action', orderable:false, searchable:false},
                        { data: 'nama', name: 'nama', orderable:true},
                        { data: 'sub_instansi', name:'sub_instansi', orderable:true},
                        { data: 'link', name: 'link', orderable:false,
                            render: function(data, type, row) {
                            // Membuat link yang bisa diklik
              ...
              //Instansi
                //Tambah Instansi
                    $('#tambah-instansi').on('click',function(){
                        document.getElementById("form-tambah-instansi").reset();
                        $('#tambah-instansi').hide(); $('#add-instansi').show(); $('#edit-instansi').hide(); $('#hapus-instansi').hide();
                        $('#tambah_nama_instansi').hide();$('#tambah_nama_instansi').val('');$('#tambah_username_instansi').val('');$('#tambah_email_instansi').val(''); $('#tambah_password_instansi').val('');$('#tambah_link_instansi').val('');
                        $('#tambahnamainstansi').select2({
                            placeholder: 'Pilih Instansi',
                            ajax: {
                                url: '{!! url("dropdown-instansitender") !!}',
                                dataType: 'json',
                    ...
                    $('#tambahnamainstansi').on('change',function(){
                        var instansi = $(this).val();
                        console.log(instansi);
                        if(instansi == "baru"){
                            $('#tambah_nama_instansi').show();
                        } else {
                            $('#tambah_nama_instansi').hide();
                        }
                    })
                    $('#btn-close-instansi').on('click',function(){
                       $('#tambah-instansi').show(); $('#add-instansi').hide();
                    });
                    $('#form-tambah-instansi').submit(function(e){
                        e.preventDefault(); // prevent actual form submit
                        var el = $('#btn-tambah-intansi');
                        el.prop('readonly', true);
                        setTimeout(function(){el.prop('readonly', false); }, 3000);
                        var form = $(this);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if(response.success == true){
                                    ...
                                    $('#add-instansi').hide(); $('#tambah-instansi').show();
                ...
                //Tambah Instansi
                //Edit Instansi
                    $('body').on('click','.editinstansi',function(){
                        document.getElementById("form-edit-instansi").reset();
                        $('#tambah-instansi').hide(); $('#add-instansi').hide(); $('#edit-instansi').show(); $('#hapus-instansi').hide();
                        $('#edit_nama_instansi').hide();
                        $('#edit_nama_instansi').val('');$('#edit_username_instansi').val('');$('#edit_email_instansi').val(''); $('#edit_password_instansi').val('');$('#edit_link_instansi').val('');
                        var id = $(this).data('kode');
                        $('#editnamainstansi').select2({
                            placeholder: 'Pilih Instansi',
                            ajax: {
                                url: '{!! url("dropdown-instansitender") !!}',
                                dataType: 'json',
                       ...
                       $.ajax({
                          ...
                          success : function(response){
                            ...
                            $('#editnamainstansi')
                              .empty() //empty select
                              .append($("<option/>") //add option tag in select
                                  .val(response.data.nama) //set value for option to post it
                                  .text(response.data.nama )) //set a text for show in select
                              .val(response.data.nama) //select option of select2
                              .trigger("change"); //apply to select2
                            
                            $('#edit_sub_instansi').val(response.data.sub_instansi);
                            $('#edit_username_instansi').val(response.data.username);
                            $('#edit_email_instansi').val(response.data.email);
                            $('#edit_password_instansi').val(response.data.password);
                            $('#edit_link_instansi').val(response.data.link);
                          }
                        });
                       
                    });
                    $('#editnamainstansi').on('change',function(){
                        var instansi = $(this).val();
                        if(instansi == "baru"){
                            $('#edit_nama_instansi').show();
                        } else {
                            $('#edit_nama_instansi').hide();
                        }
                    })
                    $('#btn-edit-close-instansi').on('click',function(){
                       $('#tambah-instansi').show(); $('#edit-instansi').hide();
                       
                    });
                    $('#form-edit-instansi').submit(function(e){
                        e.preventDefault(); // prevent actual form submit
                        var el = $('#btn-edit-intansi');
                        el.prop('readonly', true);
                        setTimeout(function(){el.prop('readonly', false); }, 3000);
                        var form = $(this);
                        var method = form.attr('method');
                        var data = new FormData(form[0]);
                        var id = $('#edit_id_instansi').val();
                        if($('#editnamainstansi').val() == "baru"){
                            var nama = $('#edit_nama_instansi').val();
                        } else {
                            var nama = $('#editnamainstansi').val();
                        }
                        try {
                            $.ajax({
                              type: 'PUT',
                              url: '{!! url("data-instansitender/'+id+'") !!}',
                              data : {
                                nama     : nama,
                                _token   : token,
                                sub_instansi : $('#edit_sub_instansi').val(),
                                link   : $('#edit_link_instansi').val(),
                                username  : $('#edit_username_instansi').val(),
                                password  : $('#edit_password_instansi').val(),
                                email : $('#edit_email_instansi').val(), 
                              }, // serializes form input
                              success:function(response) {
                                // // console.log(response);
                                ...
                                if(response.success == true){
                                  ...
                                  $('#edit-instansi').hide(); $('#tambah-instansi').show();
                                  var table = $('#tabel-instansi').DataTable(); 
                                  table.ajax.reload( null, false );
                                } else {
                                  Toast.fire({
                ...
                // Edit Instansi
                //Hapus Instansi
                    $('body').on('click','.hapusinstansi',function(){
                        document.getElementById("form-hapus-instansi").reset();
                        $('#tambah-instansi').hide(); $('#add-instansi').hide(); $('#edit-instansi').hide(); $('#hapus-instansi').show();
                        var nama = $(this).data('nama');
                        var id = $(this).data('kode');
                        $('#hapus_id_instansi').val(id);
                        $('#hapus_nama_instansi').html(nama);
                    });
                    $('#btn-hapus-close-instansi').on('click',function(){
                       $('#tambah-instansi').show(); $('#hapus-instansi').hide();
                    });
                    $('#form-hapus-instansi').submit(function(e){
                        e.preventDefault(); // prevent actual form submit
                        var el = $('#btn-hapus-instansi');
                        el.prop('readonly', true);
                        setTimeout(function(){el.prop('readonly', false); }, 3000);
                        var token = "{!! csrf_token() !!}";
                        var id = $('#hapus_id_instansi').val();
                        $.ajax({
                          type    : 'delete',
                          url     : '{!! url("data-instansitender/'+id+'") !!}',
                          data    : {
                          ...
                          success:function(response) {
                            ...
                            if(response.success){
                              ...
                              $('#hapus-instansi').hide(); $('#tambah-instansi').show();
                              var table = $('#tabel-instansi').DataTable(); 
                              table.ajax.reload( null, false );
                            } else {
                              Toast.fire({
              ...
              //Pejabat
                //Tambah Pejabat
                    $('#tambah-pejabat').on('click',function(){
                        ...
                        $('#tambah_instansi_pejabat').select2({
                          placeholder : 'Pilih Instansi',
                          ajax  :{
                            url : '{!! url("dropdown-instansitender") !!}',
                            dataType: 'json',
                ...
                //Detail Pejabat
                    $(document).on('click','.detailpejabat',function(){
                        ...
                        $.ajax({
                          ...
                          success : function(response){
                            console.log(response);
                            $('#detail_instansi_pejabat').val(response.data.namainstansi);
                ...
                // Edit Pejabat
                    $(document).on('click','.editpejabat',function(){
                       ...
                       $.ajax({
                          ...
                          success : function(response){
                            console.log(response);
                            $('#edit_instansi_pejabat').val('1'); // Select the option with a value of '1'
                            $('#edit_instansi_pejabat').trigger('change');
