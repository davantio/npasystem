              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row invoice-info">
                  <div class="col-sm-5 invoice-col invoice-header">
                    <img src="{{asset('img')}}/triputra.png" alt="Logo" width="200" height="300">
                </div>
                ...
                <!-- info row -->
                <div class="row invoice-info">
                  <div class="col-sm-5 invoice-col d-flex align-items-center " style="background-color: #5ce1e6;">
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-sm-5 background-opacity" >
                      <div class="content">
                          <div class="row d-flex align-items-center " style="background-color: #5ce1e6;">
                            <h4><b>CATATAN :</b></h4>
                        </div>
                        <div class="row" >
...
<script>
  ...
  function tabelbarang(tabel,data){
    ...
    console.log(total);
    var row = $("<tr>");
    row.html("<td colspan='2'>TERBILANG<br>#<b>"+terbilang(total + sumtax)+" Rupiah</b>#</td><td colspan='3'>HARGA JUAL<br>PPN "+pajak+" %<br><b>TOTAL</b></td><td>"+formatRupiah(total)+"<br>"+formatRupiah(sumtax)+"<br><b>"+formatRupiah(total + sumtax)+"</b></td></tr>");
    $(tabel).append(row);
