...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                <a href="intagro" class="nav-item nav-link active">Home</a>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                    <img class="img-fluid" src="https://i.pinimg.com/564x/c0/6a/bf/c06abfaeb244a4627910bdaa757286c0.jpg" alt="Image">
                    <!--<img class="img-fluid" src="{{asset('dgcom')}}/img/carousel-1.jpg" alt="Image">-->
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="1" aria-label="Slide 2">
                    <!--<img class="img-fluid" src="{{asset('dgcom')}}/img/carousel-2.jpg" alt="Image">-->
                    <img class="img-fluid" src="https://imgsrv2.voi.id/4j9GT6OEbLsaSGM1ygI3Lnsdi32IgwHtKRMH_m5qZsI/auto/1200/675/sm/1/bG9jYWw6Ly8vcHVibGlzaGVycy8zMDI1MzUvMjAyMzA4MTcyMjA3LW1haW4uY3JvcHBlZF8xNjkyMjg0ODY1LmpwZw.jpg" alt="Image">
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="2" aria-label="Slide 3">
                    <!--<img class="img-fluid" src="{{asset('dgcom')}}/img/carousel-3.jpg" alt="Image">-->
                    <img class="img-fluid" src="https://www.globaltimes.cn/Portals/0/attachment/2021/2021-08-15/681b37e2-86bb-4023-b458-7f6672cfa6b7.jpeg" alt="Image">
                </button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="https://i.pinimg.com/564x/c0/6a/bf/c06abfaeb244a4627910bdaa757286c0.jpg" alt="Image">
                    <!--<img class="w-100" src="{{asset('dgcom')}}/img/carousel-1.jpg" alt="Image">-->
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">We Are Focus On</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Fertilizer & Various Commodity</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="https://imgsrv2.voi.id/4j9GT6OEbLsaSGM1ygI3Lnsdi32IgwHtKRMH_m5qZsI/auto/1200/675/sm/1/bG9jYWw6Ly8vcHVibGlzaGVycy8zMDI1MzUvMjAyMzA4MTcyMjA3LW1haW4uY3JvcHBlZF8xNjkyMjg0ODY1LmpwZw.jpg" alt="Image">
                    <!--<img class="w-100" src="{{asset('dgcom')}}/img/carousel-2.jpg" alt="Image">-->
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Secure Warehouse</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Make Sure Our Products Quality is Our Priority</h1>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    <img class="w-100" src="https://www.globaltimes.cn/Portals/0/attachment/2021/2021-08-15/681b37e2-86bb-4023-b458-7f6672cfa6b7.jpeg" alt="Image">
                    <!--<img class="w-100" src="{{asset('dgcom')}}/img/carousel-3.jpg" alt="Image">-->
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-4 animated zoomIn">Shipping Partner</h4>
                            <h1 class="display-1 text-white mb-0 animated zoomIn">Fast and Safe Delivery</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        <i class="fa fa-certificate fa-4x text-intagro mb-4"></i>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        <i class="fa fa-users-cog fa-4x text-intagro mb-4"></i>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        <i class="fa fa-users fa-4x text-intagro mb-4"></i>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        <i class="fa fa-check fa-4x text-intagro mb-4"></i>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a class="service-item d-block rounded text-center h-100 p-4" href="">
                        <img class="img-fluid rounded mb-4" src="{{asset('image')}}/micro f.jpg" alt="">
                        <h4 class="mb-0">Micro Nutrient Fertilizer</h4>
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a class="service-item d-block rounded text-center h-100 p-4" href="">
                        <img class="img-fluid rounded mb-4" src="{{asset('image')}}/organic f.jpg" alt="">
                        <h4 class="mb-0">Natural/Organic Fertilizer</h4>
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="service-item d-block rounded text-center h-100 p-4" href="">
                        <img class="img-fluid rounded mb-4" src="{{asset('image')}}/commodity f.jpg" alt="">
                        <h4 class="mb-0">Various Commodity</h4>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-intagro pe-3">Why Choose Us</h6>
                        <h1 class="display-6 mb-4">Why People Trust Us? Learn About Us!</h1>
                        <p class="mb-4">We provide various kinds of industrial supply needs, especially in the <b>Fertilizer</b> sector (Micro, Macro and Natural), apart from that we also provide several <b>Various Commodities</b> such as clove oil, coffee bean, cocoa bean, eugenol and wood pellets</p>
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="skill">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2"><b>OUR PRODUCT</b></p>
                                        <p class="mb-2">95%</p>
                                    </div>
                                    <div class="progress">
                            ...
                            <div class="col-12">
                                <div class="skill">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2"><b>OUR SERVICES</b></p>
                                        <p class="mb-2">95%</p>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                            ...
                            <div class="col-12">
                                <div class="skill">
                                    <div class="d-flex justify-content-between">
                                        <p class="mb-2"><b>OUR SHIPPING</b></p>
                                        <p class="mb-2">90%</p>
                                    </div>
                                    <div class="progress">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="img-border">
                        <img class="img-fluid" src="{{asset('dgcom')}}/img/feature.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <h1 class="display-6 mb-4">Learn More About Our Product Quality</h1>
            </div>
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="project-item border rounded h-100 p-4" data-dot="01">
                    <div class="position-relative mb-4">
                        <!--<img class="img-fluid rounded" src="{{asset('dgcom')}}/img/project-1.jpg" alt="">-->
                        <img class="img-fluid rounded" src="https://img.id.my-best.com/content_section/choice_component/sub_contents/fc64e1034e6312fd1056bd544b391b6d.jpg?ixlib=rails-4.3.1&q=70&lossless=0&w=690&fit=max&s=8d270861fb97c5b253103005239408be" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-1.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">Urea</h6>
                    <div class="row">
                        <div class="col-lg-4 text-center">
                            <span>N <br> 46%</span>
                        </div>
                        <div class="col-lg-4 text-center" style="border-right-style: solid; border-left-style: solid;">
                            <span>Form <br> Prill</span>
                        </div>
                        <div class="col-lg-4 text-center">
                            <span>Moisture <br> 1%</span>
                        </div>
                    </div>
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="02">
                    <div class="position-relative mb-4">
                        <!--<img class="img-fluid rounded" src="{{asset('dgcom')}}/img/project-2.jpg" alt="">-->
                        <img class="img-fluid rounded" src="https://partojambe.com/asset/foto_produk/6274d7664299b.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-2.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">TSP</h6>    
                    <div class="row">
                        <div class="col-lg-6 text-center">
                            <span>P2O5 <br> 46%</span>
                        </div>
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="03">
                    <div class="position-relative mb-4">
                        <!--<img class="img-fluid rounded" src="{{asset('dgcom')}}/img/project-3.jpg" alt="">-->
                        <img class="img-fluid rounded" src="https://www.shutterstock.com/image-photo/18460-diammonium-phosphate-dap-fertilizers-600w-792508927.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-2.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">DAP</h6>
                    <div class="row">
                        <div class="col-lg-4 text-center">
                            <span>NH4 <br> 18%</span>
                        </div>
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="04">
                    <div class="position-relative mb-4">
                        <!--<img class="img-fluid rounded" src="{{asset('dgcom')}}/img/project-3.jpg" alt="">-->
                        <img class="img-fluid rounded" src="https://m.media-amazon.com/images/I/7149KKNtQaL.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-4.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">MOP</h6>
                    <div class="row">
                        <div class="col-lg-6 text-center">
                            <span>K20 <br> 60%</span>
                        </div>
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="05">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="https://5.imimg.com/data5/SELLER/Default/2023/3/291764963/LS/KU/FH/1187885/copper-sulphate-cuso4-tech-pure-ep-cu-24to-25--500x500.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-5.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">CuSO4</h6>
                    <span class="text-center">CU <br> N/A%</span>
                </div>
                <div class="project-item border rounded h-100 p-4" data-dot="06">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="https://tiimg.tistatic.com/fp/1/004/769/zinc-sulfate-znso4--175.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-6.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
                    <h6 class="text-center">ZnSO4</h6>
                    <span class="text-center">Zn <br> N/A%</span>
                </div>
                ...
                <!--    <div class="position-relative mb-4">-->
                <!--        <img class="img-fluid rounded" src="{{asset('dgcom')}}/img/project-9.jpg" alt="">-->
                <!--        <a href="{{asset('dgcom')}}/img/project-9.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                <!--    </div>-->
                <!--    <h6>NPKCM (N - P2O5 - K2O Carbon Mollases)</h6>-->
                ...
                <div class="project-item border rounded h-100 p-4" data-dot="14">
                    <div class="position-relative mb-4">
                        <img class="img-fluid rounded" src="https://solarnusantara.id/wp-content/uploads/2023/02/Wood-Pellet-1.jpg" alt="">
                        <!--<a href="{{asset('dgcom')}}/img/project-10.jpg" data-lightbox="project"><i class="fa fa-eye fa-2x"></i></a>-->
                    </div>
    ...
    {{-- <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h6 class="section-title bg-white text-center text-intagro px-3">Our Team</h6>
                <h1 class="display-6 mb-4">We Are A Creative Team For Your Dream Project</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="{{asset('dgcom')}}/img/team-1.jpg" alt="">
                        <div class="team-text">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="{{asset('dgcom')}}/img/team-2.jpg" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Full Name</h5>
                                <span>Designation</span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="{{asset('dgcom')}}/img/team-3.jpg" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Full Name</h5>
                                <span>Designation</span>
    ...
    <!--    <div class="container">-->
    <!--        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">-->
    <!--            <h6 class="section-title bg-white text-center text-intagro px-3">Testimonial</h6>-->
    <!--            <h1 class="display-6 mb-4">What Our Clients Say!</h1>-->
    <!--        </div>-->
    <!--        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">-->
    <!--            <div class="testimonial-item bg-light rounded p-4">-->
    <!--                <div class="d-flex align-items-center mb-4">-->
    <!--                    <img class="flex-shrink-0 rounded-circle border p-1" src="{{asset('dgcom')}}/img/testimonial-1.jpg" alt="">-->
    <!--                    <div class="ms-4">-->
    ...
    <!--            <div class="testimonial-item bg-light rounded p-4">-->
    <!--                <div class="d-flex align-items-center mb-4">-->
    <!--                    <img class="flex-shrink-0 rounded-circle border p-1" src="{{asset('dgcom')}}/img/testimonial-2.jpg" alt="">-->
    <!--                    <div class="ms-4">-->
    <!--                        <h5 class="mb-1">Client Name</h5>-->
    <!--                        <span>Profession</span>-->
    <!--                    </div>-->
    ...
    <!--            <div class="testimonial-item bg-light rounded p-4">-->
    <!--                <div class="d-flex align-items-center mb-4">-->
    <!--                    <img class="flex-wrap rounded-circle border p-1" src="{{asset('dgcom')}}/img/testimonial-2.jpg" alt="">-->
    <!--                    <div class="ms-4">-->
    ...
    <!--            <div class="testimonial-item bg-light rounded p-4">-->
    <!--                <div class="d-flex align-items-center mb-4">-->
    <!--                    <img class="flex-shrink-0 rounded-circle border p-1" src="{{asset('dgcom')}}/img/testimonial-3.jpg" alt="">-->
    <!--                    <div class="ms-4">-->
    <!--                        <h5 class="mb-1">Client Name</h5>-->
    <!--                        <span>Profession</span>-->
    <!--                    </div>-->
    ...
    <!--            <div class="testimonial-item bg-light rounded p-4">-->
    <!--                <div class="d-flex align-items-center mb-4">-->
    <!--                    <img class="flex-shrink-0 rounded-circle border p-1" src="{{asset('dgcom')}}/img/testimonial-4.jpg" alt="">-->
    <!--                    <div class="ms-4">-->
    <!--                        <h5 class="mb-1">Client Name</h5>-->
    <!--                        <span>Profession</span>-->
    <!--                    </div>-->
