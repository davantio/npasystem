            ...
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                        <a href="macro-fertilizer" class="dropdown-item active">Macro Nutrient Fertilizer</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="img-border" style="border-color: #0ba1b2;">
                        <img class="img-fluid" src="{{asset('image')}}/macro f.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <h1 class="display-6 mb-4">Macro Nutrient Fertilizer</h1>
                        <p>Introducing our Macro Nutrient Fertilizer, the ultimate growth solution, featuring a balanced blend of essential macro elements: Nitrogen (N), Phosphorus (P), and Potassium (K). Tailored for a diverse range of plants, from vegetables to ornamentals, this formula enhances nutrient uptake, promotes robust growth, and ensures bountiful yields. Engineered for eco-friendliness and optimal fertilization efficiency, it boosts plant health, resilience against stress, and supports sustainable farming. Whether for large-scale agriculture or home gardening, our fertilizer is designed to nourish plants through every growth phase, leading to vibrant, healthy, and productive growth with minimal environmental impact.</p>
