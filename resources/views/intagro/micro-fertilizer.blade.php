            ...
            <div class="navbar-nav me-auto p-3 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 rounded-0 rounded-bottom m-0">
                        ...
                        <a href="micro-fertilizer" class="dropdown-item active">Micro Nutrient Fertilizer</a>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="img-border" style="border-color: #0ba1b2;">
                        <img class="img-fluid" src="{{asset('image')}}/micro f.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start text-intagro pe-3">Used For</h6>
                        <h1 class="display-6 mb-4">Micro Nutrient Fertilizer</h1>
                        <p>Discover the secret to unlocking the full potential of your plants with our cutting-edge Micro Nutrients Fertilizer. This specialized blend is infused with a precise concoction of vital micronutrients, such as Iron (Fe), Manganese (Mn), Zinc (Zn), Copper (Cu), Boron (B), Molybdenum (Mo), and Chlorine (Cl), each selected for their pivotal roles in plant health and productivity. From supercharging photosynthesis with enhanced chlorophyll production to fostering robust flower and fruit development, our formula is your key to cultivating plants that are not just surviving, but thriving. Crafted for a wide array of plant types, this fertilizer is the perfect tool to rectify specific nutrient shortfalls, bolstering plant vigor against the challenges of stress and disease. Whether you're tending to a lush garden or managing a vast agricultural operation, integrating our Micro Nutrients Fertilizer into your care regimen marks the beginning of a new era for your plants, characterized by vibrant growth and unparalleled yields, all achieved with an eye towards environmental stewardship.</p>
