...
<head>
    ...
    <style>
        ...
        .email-button {
            background-color: #008CBA; /* Blue for email button */
        }
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="img-border" style="border-color: #0ba1b2;">
                        <img class="img-fluid" src="https://media.graphassets.com/resize=fit:crop,width:1280,height:660/FFUsIOhsSKeVVHz1eHGC" alt="">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h1 class="display-6 mb-4">Contact Us</h1>
                        <p>Have a question, comment, or inquiry? We'd love to hear from you! Please feel free to reach out to us via the contact information provided below or by filling out the contact form. Our dedicated team is here to assist you and will strive to respond to your message as promptly as possible.</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <!-- Button to call the phone number -->
                                <a href="tel:+0123456789" class="call-button"><i class="fas fa-phone button-icon"></i> Call Us Now</a>
                            </div>
                            <div class='col-lg-6'>
                                <!-- Button to send email -->
                                <a href="mailto:admin01@intagro.com" class="email-button"><i class="far fa-envelope button-icon"></i> Email Us</a>
                            </div>
